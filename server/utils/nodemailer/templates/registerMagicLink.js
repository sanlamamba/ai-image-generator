const registerMagicLinkTemplate2 = (data) => {
  return `
    <!DOCTYPE html>
    <html lang="en">
    ...
    <body>
        <div class="container">
            ...
            <p>Thank you for registering with us using the email: <strong>${data.email}</strong>. We're excited to have you on board. Please verify your email address to activate your account and start using our services.</p>
...
const registerMagicLinkTemplate = (data) => {
  return `
    <!DOCTYPE html>
    <html lang="en">
...
export default registerMagicLinkTemplate;